...
private renderFieldForProperty(p, owningClass, prefix = "") {
	...
	<table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<tr>
			<th>
				<label for="${prefix}${p.name}"><g:message code="${domainClass.propertyName}.${prefix}${p.name}.label" default="${p.naturalName}" /><% if (required) { %><span class="required-indicator">*</span><% } %></label>
			</th>
