...
<div id="edit-weChatCoupon" class="content scaffold-edit" role="main">
    ...
    <g:form url="[resource: weChatCouponInstance, action: 'update']" method="PUT">
        <g:hiddenField name="version" value="${weChatCouponInstance?.version}"/>
        <fieldset class="form">
