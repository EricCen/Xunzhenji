...
<html>
	...
	<body>
		...
		<div id="edit-qrCodeSetting" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:qrCodeSettingInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${qrCodeSettingInstance?.version}" />
				<fieldset class="form">
