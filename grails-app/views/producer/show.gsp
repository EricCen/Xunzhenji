...
<html>
	...
	<body>
		...
		<div id="show-producer" class="content scaffold-show" role="main">
			...
			<div id="preview">
				<iframe src="<g:createLink action="home" controller="h5" params='[code: 123, hash: "producer_${producerInstance.id}"]'/>" height="640px" width="480px"></iframe>
			</div>
			<div class="qrcode">
				<g:qrcode action="producer" id="${producerInstance.id}"/>
				<div><strong>扫码分享</strong></div>
			</div>
			<g:form url="[resource:producerInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btnGreen left" action="edit" resource="${producerInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
