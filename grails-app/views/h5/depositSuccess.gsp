...
<div class="pay-container">
    <div class="payment-success-icon">
        ...
        <div><g:link controller="h5" action="home" class="return-home">马上返回</g:link></div>
    </div>
    ...
    <div style="margin: 10px 0 0 10px !important;"><strong>支付清单</strong></div>
    <div style="margin: 0 10px !important; border-top: 1px solid lightgrey;">
        <span>寻真记账户充值: ${payment?.amount}元</span>
    </div>
</div>
