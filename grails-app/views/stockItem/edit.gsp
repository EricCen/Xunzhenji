...
<div id="edit-stockItem" class="content scaffold-edit" role="main">
    ...
    <g:form url="[resource: stockItemInstance, action: 'update']" method="PUT">
        <g:hiddenField name="version" value="${stockItemInstance?.version}"/>
        <fieldset class="form">
